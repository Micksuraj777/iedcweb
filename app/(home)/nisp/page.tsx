  ...
  return (
    <section className="p-3">
      ...
      <div className="max-w-[1500px] mx-auto flex flex-col md:flex-row justify-center items-center gap-8 md:gap-[10%]">
        ...
        <Link href="https://drive.google.com/file/d/1FMa-jso9VOypbGynh67D6-1z4CLwHzmI/view" target="_blank" className="p-5 bg-green-500 text-white h-fit w-fit rounded-lg font-semibold hover:text-green-500 hover:bg-white hover:border-green-500 hover:border-[2px] mt-5 md:mt-0">
          DOWNLOAD
        </Link>
      </div>
    </section>
