    ...
    <section className="p-3">
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:px-8 lg:px-12">
        ...
        IEDC Room, Equipment and Tools
          ...
          <ul className="para md:pl-16 list">
            <li>
          ...
          <p className="para">
          Material cost – ₹8/gram (for members) and  ₹10/gram (for non-members)
          </p>
          <h2 className="head">
          FOR IEDC MEMBERS
          </h2>
          <ul className="para list md:pl-16">
            <li>
            ...
            <li>
            Every member should attend monthly meetings, to be aware of the current status of IEDC. Missing it continuously twice without valid reason will affect membership. As solatium <a href="https://drive.google.com/file/d/14jGgqqT0X5IpdRcnY-yd310F4xO0wz2E/view" className="link" target="_blank">Appendix 3</a> should be filled.
            </li>
            <li>
            Spending class time for any sort of activity under IEDC should be after getting signed permission <a href="https://drive.google.com/file/d/1NqVpoORGKgR2f8HRcX5HXoL52cpn5c-s/view" target="_blank" className="link">Appendix 4</a>.
            </li>
          </ul>
          <h2 className="head">
          ...
          <ul className="list para md:pl-16">
            <li>
            ...
            <li>
            Pitch an idea for an innovation or entrepreneurship, Individually or as a group of max 4 in every academic year. As to pitch register by filling the application form, as given at <a href="https://drive.google.com/file/d/1sGx1DAxZigHAbxLQQ4Uy1z351hx4AZrD/view" className="link" target="_blank">Appendix 2</a>.
            </li>
          </ul>
          <h2 className="head">
          RESPONSIBILITIES OF EACH PANELS AND TEAMS
          </h2>
          <h2 className="head">
          GENERAL
          </h2>
          ...
          <h2 className="head">
          PROJECT, INNOVATION AND PROTOTYPING PANEL
          </h2>
          <p className="para">
           <strong>Head</strong>: Chief Technical Officer (<strong>CTO</strong>)
          </p>
          <p className="para">
          ...
          <p className="para">
          <strong>Head</strong>: Chief Publicity Officer (<strong>CPO</strong>) & Chief Marketing Officer (<strong>CMO</strong>)
          </p>
          <p className="para">
